...
public Item getItemByCommandeId(Long commandeId) {
    return commandeRepository.findItemByCommandeId(commandeId);
}

    // Méthode pour récupérer le borrower d'une commande
    public User getBorrowerByCommandeId(Long commandeId) {
        return commandeRepository.findBorrowerByCommandeId(commandeId);
    }
